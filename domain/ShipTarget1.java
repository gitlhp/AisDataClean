...
/**
 * @ClassName ShipTarget1
 * @Description 融合后目标的最近一条轨迹数据。目标的信息有更新时，对表格update。\r\n注意：如果原来的静态信息字段非空，新的静态信息字段为空，则不能将该字段update为空。\r\n由程序来定期删除过期数据
 * @Author 李怀鹏
 * @Date 2019/3/31 22:33
 * @Version 1.0
 **/
//对应表结构是
public class ShipTarget1 extends BaseEntity {
    ...
    private int online;
    /** 枚举，威胁等级 */
    private int threat_level_old;
    /** isInterestTarget */
    private int isInterestTarget;
    ...
    public int getThreat_level_old() {
        return threat_level_old;
    }

    public void setThreat_level_old(int threat_level_old) {
        this.threat_level_old = threat_level_old;
    }

    public int getIsInterestTarget() {
        return isInterestTarget;
    }

    public void setIsInterestTarget(int isInterestTarget) {
        this.isInterestTarget = isInterestTarget;
    }
}
